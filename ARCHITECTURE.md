...
- WebView: **`Avalonia.Controls.WebView` (pacchetto ufficiale AvaloniaUI OÜ), versione `12.1.0`** — validato in Fase 0 (2026-08-25).
  ...
  - Stato della validazione:
    ...
    - **Windows**: non ancora verificato — nessuna macchina Windows disponibile in questo ciclo di lavoro. **Da validare prima di considerare la Fase 0 completamente chiusa.**
